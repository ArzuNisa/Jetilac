              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                      ...
                      child: Image(
                          image: AssetImage(
                              'assets/images/f61ccf70-cda6-4234-bf4a-a30e9608b857.jpg'))),
                  SizedBox(
                    height: 40,
                  ),
                  Align(
...
class elevatedButtonWidget extends StatefulWidget {
  final String title;
  elevatedButtonWidget({super.key, required this.title});
      ...
      onPressed: () {
        if (widget.title == "Kullanıcı") {
          ...
          setState(() {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const PharmacyLogin()),
            );
          });
        }
      },
